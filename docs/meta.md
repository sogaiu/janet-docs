...
* Goals
  ...
  1. Website should be improved to contain sufficient information to
     act as background for docstrings.

  2. Core API page should have examples of intended usage to be viewed
     along with docstrings.

  3. Aim for consistency among website docs, docstrings, and Core API
     examples.

  4. All aforementioned components need to remain maintainable by
     bakpakin.

* Eventual Recommended Use of Janet Documentation

  1. Read website docs and type in and experiment with examples both
...
* Current State
  ...
  1. Docstrings need review and refinement
