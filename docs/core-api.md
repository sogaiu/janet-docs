...
3. Try to exhibit surprising (but intended) cases

   Help raise awareness and refine understanding of details and
   gotchas.

4. Use brief comments to explain if needed
...
1. Use `# ->` followed by return values to show evaluation results
...
2. Try to be wary of line lengths
...
3. Don't end an example file with an empty line
